  ...
  <div class="bg-white">
    ...
    <main>
      ...
      <div class="bg-gradient-to-b from-white to-gray-100">
        ...
        <div v-if="this.faqsFiltered" class="max-w-7xl flex justify-end px-6 my-4" >
          <a href="#" 
             @click="clearFilter"
             class="flex items-center justify-center px-2 py-1 border border-blue-400 text-base font-bold rounded-md shadow-sm text-blue-400 sm:px-8 tracking-wide">VER TODO</a>
        </div>
